...
async def main():
    ...
    assert service.calculate_cycle_end_date(date(2026, 9, 1), "monthly") == date(
        2026, 9, 30
    )
    assert service.calculate_cycle_end_date(date(2026, 7, 1), "quarterly") == date(
        2026, 9, 30
    )
    assert service.calculate_cycle_end_date(date(2026, 7, 1), "half_yearly") == date(
        2026, 12, 31
    )
    assert service.calculate_cycle_end_date(date(2026, 4, 1), "yearly") == date(
        2027, 3, 31
    )
    ...
    print("performance cycle smoke scenarios passed")
