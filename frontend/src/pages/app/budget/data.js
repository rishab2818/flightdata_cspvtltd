...
export const modalFields = [
  ...
  { label: 'Estimated cost each (in Lac)', placeholder: 'Enter amount', key: 'estimated_cost', type: 'number' },
  { label: 'Demand Indication Months', placeholder: 'Enter Number', key: 'demand_indication_months', type: 'number' },
  // for the revenue / capital 
  { label: "Capital/Revenue", placeholder: "Enter Capital or revenue", key: 'capital_or_revenue',type: 'number' },
  { label: 'Build or Project/Misc', placeholder: 'Enter Name', key: 'build_or_project' },
  { label: 'DPP 2020 S No.', placeholder: 'Enter Number', key: 'dpp_number', type: 'number' },
  { label: 'Likely amount of cash Outgo Rs', placeholder: 'Enter Number', key: 'cash_outgo', type: 'number' },
  { label: 'Cash Outgo split amount', placeholder: 'Enter cash outgo split amount', key: 'cash_outgo_split', type: 'number' },
  
  { label: 'Whether Common TDCC Possible', key: 'common_tdcc', type: 'select', options: ['Yes', 'No'] },
