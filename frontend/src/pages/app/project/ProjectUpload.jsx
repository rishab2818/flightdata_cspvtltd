  ...
  return (
    <div className="project-card">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
        <div>
          <p className="summary-label" style={{ marginBottom: 4 }}>Upload data files</p>
          <h2 style={{ margin: '0 0 6px 0' }}>{project?.project_name}</h2>
          <p style={{ margin: 0, color: '#475569' }}>
            Upload multiple files, preview, and choose which ones should be processed for visualization.
          </p>
        </div>

        <button className="project-shell__nav-link" type="button" onClick={() => setOpen(true)}>
          Upload File
        </button>
      </div>
