    ...
    <div className={styles.modalOverlay}>
      <div className={styles.modalBox}>
        <div className={styles.modalHeader}>
          <div>
            <h3 className={styles.modalTitle}>Add Divisional Record</h3>
        ...
        <form className={styles.modalForm} onSubmit={handleSubmit}>
          <div className={styles.UploadGrid}>
            ...
            <label className={styles.uploadLabel}>
              <span className={styles.uploadText}>Type</span>
              <select className={styles.uploadBox} value={form.record_type} onChange={(e) => onChange("record_type", e.target.value)}>
                <option value="Budget">Budget</option>
                <option value="AMC">AMC</option>
                <option value="Cyber Security">Cyber Security</option>
              </select>
            ...
            <label className={styles.fieldGroup}>
              <span className={styles.fieldLabel}>Upload Document</span>
